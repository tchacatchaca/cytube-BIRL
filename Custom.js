...
/*player skin*/
$('head').append("<link rel='stylesheet' href='//rawgit.com/tchacatchaca/cytube-BIRL/master/polyzor-skin.min.css' />");
...
$('#footer').children('.container').append('<center><p class="text-muted credit">PRAISE THE KEK</p></center>');
